...
# ---- Register CBAM into the YAML parser namespace ----
import ultralytics.nn.tasks as tasks
from ultralytics.nn.modules import CBAM
tasks.CBAM = CBAM
print("CBAM registered:", hasattr(tasks,"CBAM"))
...
open('/kaggle/working/yolov8n-cbam.yaml','w').write('''nc: 3
scales:
  n: [0.33, 0.25, 1024]
backbone:
  - [-1, 1, Conv, [64, 3, 2]]
...
''')
SEED=42; tag="strawmind_cbam"
print("\n>>> BUILD StrawMind-CBAM")
m=YOLO('/kaggle/working/yolov8n-cbam.yaml')   # verify parse
print(">>> CBAM model built OK")
...
mt=m.val(split='test',project="runs",name=f"{tag}_seed{SEED}_test")
